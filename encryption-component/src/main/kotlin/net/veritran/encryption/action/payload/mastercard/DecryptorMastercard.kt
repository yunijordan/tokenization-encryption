...
class DecryptorMastercard(private val privateMastercardKeyLoader: MastercardPrivateKeyLoader) {

    private fun String.toMastercardEncryptedPayload() = Klaxon().parse<EncryptedMastercardPayload>(this)

    fun execute(encryptedMessage: String): String = encryptedMessage.toMastercardEncryptedPayload()
        .let(::checkNotNull)
