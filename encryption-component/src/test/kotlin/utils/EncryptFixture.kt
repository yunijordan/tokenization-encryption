...
object EncryptFixture {
    ...
    val aValidCipherTransformation = CipherTransformations.RSA_ECB_PKCS1PADDING.value
    val aKeyAlgorithm = KeyAlgorithms.RSA.value
    val anAlgorithmIdentifier = AlgorithmIdentifiers.RSA_OAEP_256.value

    val aHashAlgorithm = HashAlgorithms.SHA_256.value
    ...
    val jwePrivateKey = EncryptUtils.getPrivateKey(aPrivateKey_2048, aKeyAlgorithm)

    val symmetricKey: Key = EncryptUtils.generateAesKey(ByteUtil.randomBytes(16))
