...
object EncryptFixture {
    ...
    private const val aPrivateKey_2048 =
    ...
    val symmetricKey: Key =
        AesKey(ByteUtil.randomBytes(16))
    val asymmetricKey: String =
        Base64.getEncoder().encodeToString(symmetricKey.encoded)
}